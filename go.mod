module __anonymous__/__goapp__

go 1.15

require (
	github.com/gobardofw/cache v0.0.0-20201016195603-3b669f9fad73
	github.com/gobardofw/cli v0.0.0-20201004213813-fc5e1938a43e
	github.com/gobardofw/config v0.0.0-20201016200457-0ce92cb7f6f3
	github.com/gobardofw/console v0.0.0-20201016201112-41d3f9ae2c39
	github.com/gobardofw/container v0.0.0-20201004213034-9be5e2b3328b
	github.com/gobardofw/crypto v0.0.0-20201007195404-0b65db6d00a5
